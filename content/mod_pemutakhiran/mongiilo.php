	...
	default :
			...
			<div class='panel panel-default'>
				<div class='panel-heading'>";
                 $fg=mysqli_query($konek, "select * from pemilih where ID_DESA=2 and saring=0");
				$jml=mysqli_num_rows($fg);
				echo" Jumlah Pemilih Desa Mongiilo &nbsp; &nbsp;<strong> $jml</strong>";              
                echo"</div>";
...
case 'gandanik' :
			...
			<table class='table table-striped table-bordered table-hover' id='dataTables-example'>
				<thead>
					...
					$no=1;
			$query="SELECT NIK, NAMA, COUNT(*) as JML from pemilih where ID_DESA=2 and NIK!=0 and SARING=0 group by NIK HAVING COUNT(NIK) > 1";//"select * from pemilih where ID_DESA=2 and SARING=0";
			$tampilku=mysqli_query($konek, $query);
