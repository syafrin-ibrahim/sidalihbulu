...
switch($act){
	default :
			...
			<button type='button' class='btn' onclick=window.location.href='?syafrin=kontak&act=tambahkontak'>tambah kontak</button>
			<br/><br/>
			<div class='row'>
            <div class='col-lg-12'>
			...
			<table class='table table-striped table-bordered table-hover' id='dataTables-example'>
				<thead>
					...
					$no=1;
			$query="select * from groupk, kontak where kontak.idgroup=groupk.idgroup";
			...
			while($data=mysqli_fetch_array($tampilku)){
				...
				<td>".$data['nohp']."</td>
				<td>".$data['nmgroup']."</td>
				<td align='center'><a href=?syafrin=kontak&act=send&id=".$data['idkontak']."><i class='fa fa-envelope fa-fw'></i></a></td>
				<td align='center'><a href=?syafrin=kontak&act=editkontak&id=".$data['idkontak']."><i class='fa fa-edit'></i></a></td>
				<td align='center'><a href='$go?syafrin=kontak&perintah=hapus&id=".$data['idkontak']."' onclick=\"return confirm('yakin akan menghapus data ini ?')\">
