...
switch($act){
	default :
			echo"<div class='row'>
                <div class='col-lg-12'>
                    <h1 class='page-header'>Data Pemilih Mongiilo Utara</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<button type='button' class='btn' onclick=window.location.href='?syafrin=P_mongiiloutara&act=tambah'>input data pemilih</button>
			<button type='button' class='btn' onclick=window.location.href='?syafrin=P_mongiiloutara&act=saring'>pemilih tersaring</button>
			<button type='button' class='btn' onclick=window.location.href='?syafrin=P_mongiiloutara&act=gandanik'>pemilih ganda nik</button>
			<button type='button' class='btn' onclick=window.location.href='?syafrin=P_mongiiloutara&act=gandanama'>pemilih nama sama</button>
			<br/><br/>
			<div class='row'>
            <div class='col-lg-12'>
			...
			while($data=mysqli_fetch_array($tampilku)){
				...
				<td>".$data['NAMA']."</td>
				<td>".$data['TPS']."</td>
				<td align='center'><a href=?syafrin=P_mongiiloutara&act=penyaringan&id=".$data['DP_ID'].">saring</i></a></td>
				<td align='center'><a href=?syafrin=P_mongiiloutara&act=edit&id=".$data['DP_ID']."><i class='fa fa-edit'></i></a></td>
				<td align='center'><a href='$go?syafrin=P_mongiiloutara&perintah=hapus&id=".$data['DP_ID']."' onclick=\"return confirm('yakin akan menghapus data ini ?')\">
			...
			echo"
				...
				<div class='panel panel-default'>
						...
						<div class='col-lg-6'>
								...
								<form  role='form' class='form-group' method='post' action='$go?syafrin=P_mongiiloutara&perintah=simpan'>
...
break;
case 'edit' :
				$er=mysqli_query($konek, "select * from pemilih where ID_DESA=3 and DP_ID='".$_GET['id']."'");
			...
			echo"
				...
				<div class='panel panel-default'>
						...
						<div class='col-lg-6'>
								...
								<form  role='form' class='form-group' method='post' action='$go?syafrin=P_mongiiloutara&perintah=update'>
...
case 'saring' : 
		echo"<div class='row'>
			...
			<button type='button' class='btn' onclick=window.location.href='?syafrin=P_mongiiloutara'>lihat pemilih aktif</button>
			...
			<table class='table table-striped table-bordered table-hover' id='dataTables-example'>
				<thead>
					...
					$no=1;
			$query="select * from pemilih where ID_DESA=3 and SARING!=0";
			$tampilku=mysqli_query($konek, $query);
			$tanda="";
			while($data=mysqli_fetch_array($tampilku)){
			if($data['SARING'] == 1){
				...
				<td align='center'><a href='$go?syafrin=P_mongiiloutara&perintah=kembalikan&id=".$data['DP_ID']."' onclick=\"return confirm('yakin akan mengembalikan data ini ?')\">
				kembalikan</a></td>
		...
		$er=mysqli_query($konek, "select * from pemilih where ID_DESA=3 and DP_ID='".$_GET['id']."'");
			...
			echo"
				...
				<div class='panel panel-default'>
						...
						<div class='row'>
						<div class='col-lg-6'>
						<form  role='form' class='form-group' method='post' action='$go?syafrin=P_mongiiloutara&perintah=penyaringan'>
...
case 'gandanama' :
			...
			<button type='button' class='btn' onclick=window.location.href='?syafrin=P_mongiiloutara'>daftar pemilih aktif</button>
			<button type='button' class='btn' onclick=window.location.href='?syafrin=P_mongiiloutara&act=saring'>pemilih tersaring</button>
			...
			<table class='table table-striped table-bordered table-hover' id='dataTables-example'>
				<thead>
					...
					$no=1;
			$query="SELECT NAMA, COUNT(*) as JML from pemilih where ID_DESA=3 and SARING=0 group by NAMA HAVING COUNT(NAMA) > 1";//"select * from pemilih where ID_DESA=3 and SARING=0";
			$tampilku=mysqli_query($konek, $query);
			...
			while($data=mysqli_fetch_array($tampilku)){
				...
				<td>".$data['NAMA']."</td>
				<td>".$data['JML']."</td>
				<td align='center'><a href='?syafrin=P_mongiiloutara&act=lihatgnama&k=".$data['NAMA']."'>lihat</a></td>
...
case 'gandanik' :
			...
			while($data=mysqli_fetch_array($tampilku)){
				...
				<td>".$data['NAMA']."</td>
				<td>".$data['JML']."</a></td>
				<td align='center'><a href='?syafrin=P_mongiiloutara&act=lihatgnik&k=".$data['NIK']."'>lihat</a></td>
			</tr>";
			$no++;
			}
			echo"</tbody></table>
...
case 'lihatgnik' : 
			...
			$tampilku=mysqli_query($konek, "select * from pemilih where ID_DESA=3 and SARING=0 and NIK='$k'");
...
case 'lihatgnama' : 
			...
			$k=$_GET['k'];
			//$query="SELECT NAMA, COUNT(*) as JML from pemilih where ID_DESA=2 and SARING=0 group by NAMA HAVING COUNT(NAMA) > 1";//"select * from pemilih where ID_DESA=2 and SARING=0";
			$tampilku=mysqli_query($konek, "select * from pemilih where ID_DESA=3 and SARING=0 and NAMA like '%$k%'");
